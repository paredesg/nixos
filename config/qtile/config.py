...
# Basculer entre les côtés divisés et non divisés de la pile.
# Divisé = toutes les fenêtres affichées
# Non divisé = 1 seule fenêtre affichée, comme la disposition Max, mais
# avec plusieurs volets empilés
    Key([mod, "shift"], "Return", lazy.layout.toggle_split(), desc="Toggle between split and unsplit sides of stack"),
    Key([mod], "Return", lazy.spawn(terminal), desc="Launch terminal"),

# Toggle between different layouts as defined below
# Basculer entre différentes dispositions telles que définies ci-dessous
    ...
    Key([mod, "control"], "Return", lazy.spawn("rofi -modi drun,run -show drun -show-icons" ), desc="Launch Rofi"),
...
# My application shortcuts.
    ...
    Key([mod], "g", lazy.spawn("brave --app=https://chat.openai.com"), desc="Launch ChatGPT."),
...
# ScreenShot
   Key([mod, "control"], "print", lazy.spawn("scrot /home/loulou/screenshots/%Y-%m-%d-%T-screenshot.png"))
]
